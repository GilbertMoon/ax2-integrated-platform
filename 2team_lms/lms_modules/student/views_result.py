...
def result_list(request):
    ...
    return render(
        request,
        "lms_ui/student/result_list.html",
        {"rows": rows},
    )
...
def resubmit(request, submission_id):
    ...
    if block_reason:
        ...
        return redirect("lms:student:submission-result", submission_id=submission.id)
    ...
    if request.method == "POST" and form.is_valid():
        ...
        if resource_error:
            ...
            return render(
                request,
                "lms_ui/student/resubmission_form.html",
                {
                    "submission": submission,
        ...
        try:
            with transaction.atomic():
                ...
                if block_reason:
                    ...
                    messages.error(request, block_reason)
                    return redirect(
                        "lms:student:submission-result", submission_id=locked.id
                    )
...
def result(request, submission_id):
    ...
    return render(
        request,
        "lms_ui/student/result_view.html",
        {
            "assignment": assignment,
            "submission": submission,
            "evaluation": evaluation,
