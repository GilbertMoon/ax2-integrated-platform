...
class GenerateMappingTests(SimpleTestCase):
    ...
    def test_maps_score_and_comment_and_ignores_requirements_check(self):
        ...
        with patch("lms_modules.tutor.ai_gemini._read_text", return_value="code"), \
             patch("lms_modules.tutor.ai_gemini.genai.Client", side_effect=_fake_client(parsed)):
    ...
    def test_falls_back_to_next_model_on_server_error(self):
        ...
        with patch("lms_modules.tutor.ai_gemini._read_text", return_value="code"), \
             patch("lms_modules.tutor.ai_gemini.genai.Client",
