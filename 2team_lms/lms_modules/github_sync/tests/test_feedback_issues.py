...
from lms_modules.core.models import Assignment, Evaluation, Submission, SubmissionFile
from lms_modules.github_sync import services
from lms_modules.github_sync.github_api import GithubApiError
from lms_modules.github_sync.models import (
    FeedbackIssue,
...
class FeedbackIssueTests(TestCase):
    ...
    @patch("lms_modules.github_sync.services.github_api.create_issue",
    ...
    @patch("lms_modules.github_sync.services.github_api.add_issue_comment",
    ...
    def test_signal_triggers_on_commit(self, create_issue):
        self._tutor()
        with self.captureOnCommitCallbacks(using="assignment_lms", execute=True):
