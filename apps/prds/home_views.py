...
def _parse_filters(request):
    ...
    return HomeFilters(
        ...
        round_scope=request.GET.get("round_scope", "all"),
        project_scope=request.GET.get("project_scope", "all"),
...
def tutor_students(request):
    ...
    try:
        ...
        context = _resolve_context(request)
        data = HomeQueryService(get_integration_repository()).get_tutor_students(
            context=context,
