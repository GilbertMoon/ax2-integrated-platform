...
from lms_modules.github_sync.models import SubmissionPush
...
class SignalTests(TestCase):
    ...
    @patch("lms_modules.github_sync.services.try_sync_now")
    ...
    @patch("lms_modules.github_sync.services.try_sync_now", side_effect=RuntimeError("GitHub 느림"))
