...
from lms_modules.common.preview import _notebook_cells, _read_text
from lms_modules.core.models import Submission
            ...
            if text is None:
                ...
                if github_fetch.is_github_url(submission_file.file_url):
                    reason = (
                        ...
                        else "GitHub 파일·폴더를 읽지 못함 (공개 여부·경로·텍스트 파일 확인 필요)"
                    )
                else:
                    reason = "지원하지 않는 링크"
