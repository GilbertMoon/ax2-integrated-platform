    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("pending", "계산 중"), ("succeeded", "완료"), ("failed", "실패")],
                        default="pending",
                        max_length=16,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="contribution_scores",
                        to="prds.prdcomment",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="comment_scores",
                        to="ai.contributionevaluation",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("prd", "calculation_version"), name="uniq_contribution_calculation_version"
            ),
        ),
        migrations.AddConstraint(
            model_name="contributionevaluation",
            constraint=models.CheckConstraint(
                condition=models.Q(("calculation_version__gte", 1)),
        ...
        migrations.AddConstraint(
            model_name="contributionevaluation",
            constraint=models.CheckConstraint(
                condition=models.Q(("prd_version__gte", 1)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("evaluation", "comment"), name="uniq_contribution_comment_score"
            ),
        ),
        migrations.AddConstraint(
            model_name="contributioncommentscore",
        ...
        migrations.AddConstraint(
            model_name="contributioncommentscore",
            constraint=models.CheckConstraint(
                condition=models.Q(("reflection_score__gte", 0), ("reflection_score__lte", 100)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("evaluation", "user_id"), name="uniq_contribution_user_score"
            ),
        ),
        migrations.AddConstraint(
            model_name="contributionuserscore",
            constraint=models.CheckConstraint(
                condition=models.Q(("user_id__gt", 0)), name="contribution_user_positive"
            ),
        ),
        migrations.AddConstraint(
            model_name="contributionuserscore",
        ...
        migrations.AddConstraint(
            model_name="contributionuserscore",
            constraint=models.CheckConstraint(
                condition=models.Q(("memo_contribution__gte", 0), ("memo_contribution__lte", 100)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("comment_contribution__gte", 0), ("comment_contribution__lte", 100)
                ),
