...
from lms_modules.core.models import Lecture, Lesson
...
def student_lecture_list_view(request):
    ...
    return render(request, 'lms_ui/student/lecture_list.html', context)
...
def student_lecture_detail_view(request, lesson_id):
    ...
    return render(request, 'lms_ui/student/lecture.html', context)
