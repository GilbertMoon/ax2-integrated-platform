...
from lms_modules.github_sync import services
from lms_modules.github_sync.github_api import GithubApiError
from lms_modules.github_sync.models import StudentGithubAccount, SubmissionPush
...
class ServiceTests(TestCase):
    ...
    def setUp(self):
        ...
        p = patch(
            "lms_modules.github_sync.services.accounts.get_current_round",
    ...
    @patch("lms_modules.github_sync.services.github_api.put_file", return_value="commitsha")
    @patch("lms_modules.github_sync.services.github_api.get_file_sha", return_value=None)
    @patch("lms_modules.github_sync.services.github_api.ensure_repo",
    ...
    @patch("lms_modules.github_sync.services.github_api.get_file_sha", return_value=None)
    @patch("lms_modules.github_sync.services.github_api.put_file",
    ...
    # --- finalize_due ---
    @patch("lms_modules.github_sync.services.github_api.put_file", return_value="finalsha")
    @patch("lms_modules.github_sync.services.github_api.get_file_sha", return_value="oldsha")
...
class LinkSubmissionTests(TestCase):
    ...
    @patch("lms_modules.github_sync.services.github_api.get_file_sha", return_value=None)
    @patch("lms_modules.github_sync.services.github_api.put_file", return_value="sha1")
    @patch("lms_modules.github_sync.services.github_api.get_file_content", return_value=b"df = 1\n")
    ...
    @patch("lms_modules.github_sync.services.github_api.get_file_sha", return_value=None)
    @patch("lms_modules.github_sync.services.github_api.put_file", return_value="sha1")
    @patch("lms_modules.github_sync.services.github_api.get_file_content")
    ...
    @patch("lms_modules.github_sync.services.github_api.get_file_sha", return_value=None)
    @patch("lms_modules.github_sync.services.github_api.put_file", return_value="sha1")
    @patch("lms_modules.github_sync.services.github_api.get_file_content", return_value=b"x\n")
