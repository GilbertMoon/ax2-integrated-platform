...
#   - 저장: lms_modules.core.models.ASSIGNMENT
...
def submission_dashboard(request, pk):
    ...
    return render(
        request,
        "lms_ui/tutor/submission_dashboard.html",
        {
            "assignment": assignment,
            "rows": rows,
            "is_overdue": (
...
def submission_remind(request, pk, unit_id):
    ...
    if already_submitted:
        ...
        return redirect("lms:tutor:submission-dashboard", pk=assignment.pk)
