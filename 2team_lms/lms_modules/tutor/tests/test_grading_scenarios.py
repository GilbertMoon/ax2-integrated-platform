...
from lms_modules.tutor import grading
...
class FullCohortScenario(TestCase):
    ...
    def results(self):
        with patch("lms_modules.tutor.grading.accounts.get_student_teams", return_value=self.teams):
...
class PolicyAndEdgeTests(TestCase):
    ...
    def test_policy_change_is_reflected(self):
        ...
        from lms_modules.tutor.models import GradingPolicy
    ...
    def test_doc_worked_example(self):
        ...
        with patch("lms_modules.tutor.grading.accounts.get_student_teams",
    ...
    def test_get_student_teams_failure_falls_back_to_no_team(self):
        ...
        with patch("lms_modules.tutor.grading.accounts.get_student_teams", side_effect=RuntimeError):
            r = grading.compute([1], now=NOW)[1]
