...
class OfflineRunner(DiscoverRunner):
    def run_tests(self, *args, **kwargs):
        with patch('requests.sessions.Session.request', side_effect=AssertionError('Live HTTP is forbidden in QA')):
...
STORAGES = {
    ...
    'lms': {'BACKEND': 'django.core.files.storage.InMemoryStorage', 'OPTIONS': {'base_url': '/lms-media/'}},
}
